	...
	<div id="div0">
		...
		<div id="div2">
		    <table border="1" cellpadding="4" cellspacing="0">
		        <tr>
		        	<th><a href="product.do?page=1&group=${activeGroupId}&${sortedNameColumn}=sno">
		            	STUDENTID
		            </a></th>		        
		        	<th><a href="product.do?page=1&group=${activeGroupId}&${sortedNameColumn}=firstname">
		            	FIRST NAME
		            </a></th>
		            <th><a href="product.do?page=1&group=${activeGroupId}&${sortedPriceColumn}=section">
		            	SECTION
		            </a></th>
		        </tr>
		 
		        <c:forEach var="student" items="${productList}">
		            <tr>
